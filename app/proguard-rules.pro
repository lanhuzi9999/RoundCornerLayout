...
-keep class com.cmic.mmnes.bean.PtcBaseEntity
-keep class * extends com.cmic.mmnes.bean.PtcBaseEntity { *; }
-keep interface com.cmic.mmnes.bean.PtcBaseEntity {*;}
...
#okserver
-dontwarn com.cmic.mmnes.okserver.**
-keep class com.cmic.mmnes.okserver.**{*;}

-keep class com.cmcc.proxy.* {
    <fields>;
    <methods>;
}

-keep class com.cmcc.sso.* {
    <fields>;
    <methods>;
}
